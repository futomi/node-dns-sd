...
class DnsSd {
    ...
    * ---------------------------------------------------------------- */
    async discover(params) {
        if (this._discovery_pending || this._is_discovering === true) {
        ...
        // Reserve the operation before binding, and keep it reserved through
        // socket cleanup. _is_discovering only covers the packet collection phase.
        this._discovery_pending = true;
        const device_list = [];
        try {
